  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Pengantar</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Form Permintaan Surat Pengantar</h5>
            ...
            <form action="" method="get">
              ...
              <div class="row mb-3">
                <div class="col-sm-10">
                  <a href="<?php echo site_url('surat/downpen/'.$selectedId['id_warga']); ?>" class="btn btn-primary" name="submit">Cetak Surat</a>
                </div>
              </div>
...
<script>
  function updateSelectedId(select) {
    ...
    var href = "<?php echo site_url('surat/downpen/'); ?>" + selectedValue;
