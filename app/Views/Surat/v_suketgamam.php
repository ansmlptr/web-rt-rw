  ...
  <section class="section">
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Form Permintaan Surat Keterangan Tidak Mampu</h5>
            ...
            <form action="" method="get">
              ...
              <div class="row mb-3">
                <div class="col-sm-10">
                  <a href="<?php echo site_url('surat/downgam/'.$selectedId['id_warga']); ?>" class="btn btn-primary" name="submit">Cetak Surat</a>
                </div>
              </div>
...
<script>
  function updateSelectedId(select) {
    ...
    var href = "<?php echo site_url('surat/downgam/'); ?>" + selectedValue;
