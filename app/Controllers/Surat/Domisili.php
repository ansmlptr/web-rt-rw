...
class Domisili extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('Surat/v_suketdom', $data);
    ...
    public function downloadPDF($id_warga = null)
    {
        ...
        $pdf->setFont('times', 'B', 16);
        $pdf->cell(210, 20, 'SURAT KETERANGAN DOMISILI', 0, 1, 'C');
        $pdf->cell(210, 1, '', 0, 1);
        ...
        $pdf->cell(100, 5, '', 0, 1);
        $pdf->setFont('times', '', 12);
        $pdf->cell(80, 8, 'Adalah benar warga kami yang beralamat tersebut diatas dan berdomilisi di lingkungan RT 005 RW 026', 0, 1, 'L');
        $pdf->cell(80, 8, 'Desa Sumber Jaya Kec. Tambun Selatan, Kabupaten Bekasi.', 0, 1, 'L');
        $pdf->cell(80, 8, 'Demikian Surat Keterangan Domisili ini kami buat dengan sebenarnya dan agar dipergunakan', 0, 1, 'L');
